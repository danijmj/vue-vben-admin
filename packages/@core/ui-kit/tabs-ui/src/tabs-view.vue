...
import { useForwardPropsEmits } from '@optiml-core/composables';
import { ChevronLeft, ChevronRight } from '@optiml-core/icons';
import { VbenScrollbar } from '@optiml-core/shadcn-ui';
