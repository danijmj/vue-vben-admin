...
import { useSimpleLocale } from '@optiml-core/composables';
import { VbenExpandableArrow } from '@optiml-core/shadcn-ui';
import { cn, isFunction, triggerWindowResize } from '@optiml-core/shared/utils';
