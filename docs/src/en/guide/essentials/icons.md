...
- The icons in the project are mainly provided by the `@optiml/icons` package. It is recommended to manage them within this package for unified management and maintenance.
...
import { createIconifyIcon } from '@optiml-core/icons';
...
import { MdiKeyboardEsc } from '@optiml/icons';
</script>
...
```vue
<script setup lang="ts">
import { SvgTestIcon } from '@optiml/icons';
</script>
