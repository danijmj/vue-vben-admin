...
import { updatePreferences } from '@optiml/preferences';
...
- Do not place business translation texts inside `@optiml/locales` to better manage business and general translation texts.
...
With `@optiml/locales`, you can easily use translation texts:
