...
::: info You are reading the documentation for [Vben Admin](https://github.com/danijmj/vue-vben-admin) version `5.0`!
...
- [Vben Admin](https://github.com/danijmj/vue-vben-admin) is still being actively updated. Contributions are welcome to help maintain and improve the project, aiming to create a better mid- to backend solution.
